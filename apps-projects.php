                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="avatar-group">
                                        <a href="#" class="avatar" data-bs-toggle="tooltip" aria-label="Sarah Taylor">
                                            <img src="assets/images/users/avatar-5.jpg" class="rounded-circle avatar-sm" alt="friend">
                                        </a>
                                        <a href="#" class="avatar" data-bs-toggle="tooltip" aria-label="Chris Miller">
                                            <img src="assets/images/users/avatar-6.jpg" class="rounded-circle avatar-sm" alt="friend">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="avatar-group">
                                        <a href="#" class="avatar" data-bs-toggle="tooltip" aria-label="Emily Clark">
                                            <img src="assets/images/users/avatar-7.jpg" class="rounded-circle avatar-sm" alt="friend">
                                        </a>
                                        <a href="#" class="avatar" data-bs-toggle="tooltip" aria-label="Chris Miller">
                                            <img src="assets/images/users/avatar-2.jpg" class="rounded-circle avatar-sm" alt="friend">
                                        </a>
                                        <a href="#" class="avatar" data-bs-toggle="tooltip" aria-label="Chris Miller">
                                            <img src="assets/images/users/avatar-9.jpg" class="rounded-circle avatar-sm" alt="friend">
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="avatar-group">
                                        <a href="#" class="avatar" data-bs-toggle="tooltip" aria-label="John Doe">
                                            <img src="assets/images/users/avatar-8.jpg" class="rounded-circle avatar-sm" alt="friend">
                                        </a>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="avatar-group">
                                        <a href="#" class="avatar" data-bs-toggle="tooltip" aria-label="Anna Brown">
                                            <img src="assets/images/users/avatar-10.jpg" class="rounded-circle avatar-sm" alt="friend">
                                        </a>
                                        ...
                                        <a href="#" class="avatar" data-bs-toggle="tooltip" aria-label="Chris Miller">
                                            <img src="assets/images/users/avatar-1.jpg" class="rounded-circle avatar-sm" alt="friend">
                                        </a>
                                        <a href="#" class="avatar" data-bs-toggle="tooltip" aria-label="Chris Miller">
                                            <img src="assets/images/users/avatar-7.jpg" class="rounded-circle avatar-sm" alt="friend">
                                        </a>
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div class="avatar-group">
                                        <a href="#" class="avatar" data-bs-toggle="tooltip" aria-label="Mike Johnson">
                                            <img src="assets/images/users/avatar-3.jpg" class="rounded-circle avatar-sm" alt="friend">
                                        </a>
                                    </div>
                                </div>
