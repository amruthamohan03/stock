            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                        <h4>Sydonia Export - Bulk Update</h4>
                    </div>
                    <div class="card-body">
...
function validateRecords(rows) {
    ...
    $.ajax({
        url: "<?php echo APP_URL; ?>exportsydonia/validate_mca_refs",
        method: "POST",
...
function displayValidationResults() {
    ...
    // Enable button if there's at least 1 valid record
    if (validRecords.length > 0) {
...
function performUpdate() {
    ...
    // Only send valid records to server
    ...
    $.ajax({
        url: "<?php echo APP_URL; ?>exportsydonia/update_mca_refs",
        method: "POST",
