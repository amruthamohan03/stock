...
class App {
    ...
    public function __construct() {
        ...
        $pathRouting = [
            ...
            'importapurment'        => 'licenses/',
            'exportapurment'        => 'licenses/',
            'bivac'                 => 'licenses/',
            'local'                 => 'tracking/',
            'localdashboard'        => 'tracking/',
            'importdashboard'       => 'tracking/',
            'import'                => 'tracking/',
            'exportdashboard'       => 'tracking/',
            'export'                => 'tracking/',
            'payment'               =>  'payment/',
            'fiche'                 =>  'fiches/',
            'quotation'             =>  'quotations/',
            'importinvoice'         =>  'invoices/',
            'importcredit'         =>  'invoices/',
            'exportinvoice'         =>  'invoices/',
            'exportcredit'         =>  'invoices/',
            'account'               =>  'account/',
            'clientbankmapping'     =>  'mapping/',
            'sealno'                =>  'seal/',
            'bankExchangeRate'      => 'masters/',
            'importsydonia'         =>  'sydonia/',
            'exportsydonia'         =>  'sydonia/',
            'emcf'                  =>  'invoices/',
