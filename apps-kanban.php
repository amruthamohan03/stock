                                ...
                                <div class="tasklist px-3" id="upcoming">
                                    <div class="card" id="task1">
                                        <div class="card-body">
                                            ...
                                            <h5 class="mt-0"><a href="apps-task-details.php" class="text-dark fw-semibold">Android App homepage</a></h5>
                                    ...
                                    <div class="card" id="task2">
                                        <div class="card-body">
                                            ...
                                            <h5 class="mt-0"><a href="apps-task-details.php" class="text-dark fw-semibold">Dashboard layout improvements</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                    ...
                                    <div class="card" id="task3">
                                        <div class="card-body">
                                            <span class="badge bg-soft-danger text-danger float-end">High</span>
                                            <h5 class="mt-0"><a href="apps-task-details.php" class="text-dark fw-semibold">Invite team members to the project</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                    ...
                                    <div class="card task-info" id="task4">
                                        <div class="card-body">
                                            ...
                                            <h5 class="mt-0"><a href="apps-task-details.php" class="text-dark fw-semibold">Prepare user guide for the new feature</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                            ...
                            <div data-simplebar>
                                <div class="tasklist px-3" id="in-progress">
                                    <div class="card" id="task6">
                                        <div class="card-body">
                                            <span class="badge bg-soft-warning text-warning float-end">Medium</span>
                                            <h5 class="mt-0"><a href="apps-task-details.php" class="text-dark fw-semibold">Set up user authentication</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                    ...
                                    <div class="card task-info" id="task7">
                                        <div class="card-body">
                                            <span class="badge bg-soft-danger text-danger float-end">High</span>
                                            <h5 class="mt-0"><a href="apps-task-details.php" class="text-dark fw-semibold">Design the user dashboard</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                    ...
                                    <div class="card task-danger" id="task8">
                                        <div class="card-body">
                                            <span class="badge bg-soft-success text-success float-end">Low</span>
                                            <h5 class="mt-0"><a href="apps-task-details.php" class="text-dark fw-semibold">Create promotional email template</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                            ...
                            <div data-simplebar>
                                <div class="tasklist px-3" id="in-review">
                                    <div class="card" id="task9">
                                        <div class="card-body">
                                            <span class="badge bg-soft-warning text-warning float-end">Medium</span>
                                            <h5 class="mt-0"><a href="apps-task-details.php" class="text-dark fw-semibold">Set up tracking for user interactions</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                    ...
                                    <div class="card task-info" id="task10">
                                        <div class="card-body">
                                            <span class="badge bg-soft-danger text-danger float-end">High</span>
                                            <h5 class="mt-0"><a href="apps-task-details.php" class="text-dark fw-semibold">Design new project management interface</a></h5>
                                            <div class="form-check float-end ps-0">
                                                <input class="form-check-input" type="checkbox" value="">
                                            </div>
                                ...
                                <div data-simplebar>
                                    <div class="tasklist px-3" id="completed">
                                        <div class="card task-warning" id="task11">
                                            <div class="card-body">
                                                <span class="badge bg-soft-success text-success float-end">Low</span>
                                                <h5 class="mt-0"><a href="apps-task-details.php" class="text-dark fw-semibold">Brand logo design</a></h5>
                                                <div class="form-check float-end ps-0">
                                                    <input class="form-check-input" type="checkbox" value="">
                                                </div>
                                        ...
                                        <div class="card task-success" id="task12">
                                            <div class="card-body">
                                                <span class="badge bg-soft-warning text-warning float-end">Medium</span>
                                                <h5 class="mt-0"><a href="apps-task-details.php" class="text-dark fw-semibold">Improve animation loader</a></h5>
                                                <div class="form-check float-end ps-0">
                                                    <input class="form-check-input" type="checkbox" value="">
                                                </div>
                                        ...
                                        <div class="card" id="task13">
                                            <div class="card-body">
                                                <span class="badge bg-soft-danger text-danger float-end">High</span>
                                                <h5 class="mt-0"><a href="apps-task-details.php" class="text-dark fw-semibold">Dashboard Re-design</a></h5>
                                                <div class="form-check float-end ps-0">
                                                    <input class="form-check-input" type="checkbox" value="">
                                                </div>
                                        ...
                                        <div class="card task-info" id="task14">
                                            <div class="card-body">
                                                <span class="badge bg-soft-success text-success float-end">Low</span>
                                                <h5 class="mt-0"><a href="apps-task-details.php" class="text-dark fw-semibold">iOS App home page</a></h5>
                                                <div class="form-check float-end ps-0">
                                                    <input class="form-check-input" type="checkbox" value="">
                                                </div>
